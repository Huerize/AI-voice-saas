      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="bg-slate-800/50 backdrop-blur-lg border border-slate-700 rounded-xl p-6 shadow-lg">
            <h2 className="text-xl font-semibold mb-4">Voice Agent Status</h2>
            <p className="text-slate-300">Access the voice agent dashboard to configure and use your AI voice agents.</p>
            <Button 
              onClick={() => navigate("/voice-agent")} 
              variant="outline" 
              className="mt-4 border-violet-500 text-violet-400 hover:bg-violet-500/10"
            >
